...
class TestContactFromMainPage:
    ...
    def test_guest_should_see_link_tensor_page(self, browser):
        logging.info("Starting test_guest_should_see_link_tensor_page")
        page = SbisContactPage(browser, SbisUrls.SBIS_CONTACT_PAGE_LINK)
        page.open()
        ...
        logging.info("Test test_guest_should_see_link_tensor_page passed successfully")

    def test_guest_can_edit_current_region(self, browser):
        logging.info("Starting test_guest_can_edit_current_region")
        page = SbisContactPage(browser, SbisUrls.SBIS_CONTACT_PAGE_LINK)
        page.open()
        ...
        logging.info("Test test_guest_can_edit_current_region passed successfully")
